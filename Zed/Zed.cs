...
namespace iDZed
{
    ...
    internal static class Zed
    {
        ...
        /// <returns>
        /// </returns>
        private static AIHeroClient GetAssasinationTarget(float vDefaultRange = 0, DamageType vDefaultDamageType = DamageType.Physical)
        {
            if (Math.Abs(vDefaultRange) < 0.00001)
                vDefaultRange = _spells[SpellSlot.Q].Range;
